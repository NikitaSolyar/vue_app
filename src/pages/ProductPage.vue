...
<template>
  <div>
    <main class="content container" v-if="productLoading">Загрузка товара...<img src="@/assets/Ghost.gif" alt="загрузка"></main>
    <main class="content container" v-else-if="!productData">Не удалось получить информацию о товаре</main>
          ...
          <div class="item__form">
            <form class="form" action="#" method="POST" @submit.prevent="addToCart">
              ...
              <fieldset class="form__block">
                ...
                <ul class="colors">
                  <li class="colors__item" v-for="color in productData.colors" :key="color.code">
                    <label class="colors__label" for="icol">
                      <input
              ...
              <fieldset class="form__block">
                ...
                <ul class="sizes sizes--primery">
                  <li class="sizes__item">
                    <label class="sizes__label" for="ivol">
                      <input class="sizes__radio sr-only" type="radio" name="sizes-item" value="32" id="ivol">
                  ...
                  <li class="sizes__item">
                    <label class="sizes__label" for="ivol1">
                      <input class="sizes__radio sr-only" type="radio" name="sizes-item" value="64" id="ivol1">
                      <span class="sizes__value">
                        64gb
                      </span>
                    </label>
                  ...
                  <li class="sizes__item">
                    <label class="sizes__label" for="ivol2">
                      <input class="sizes__radio sr-only" type="radio" name="sizes-item" value="128" checked="" id="ivol2">
                      <span class="sizes__value">
                        128gb
                      </span>
                    </label>
              ...
              <div class="item__row">
                ...
                <productAdd :amount.sync="productAmount" />
              ...
              <div v-if="productAddSending">Товар добавляется в корзину<img src="@/assets/Ghost.gif" alt="загрузка"></div>
            </form>
          </div>
        </div>
